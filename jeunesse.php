...
<section id="portfolio">
            ...
            <div class="col-md-12 col-sm-12">           
               ...
               <div class="iso-section wow fadeInUp">
                  <ul class="filter-wrapper">
                     ...
                     <li><a href="romans.php"><i class="ion-ios-book ion-icon-big wow fadeInUp thick" data-wow-delay="1.3s"></i><p>ROMANS</p></a></li>
                     ...
                     <li><a href="jeunesse.php"><i class="ion-ios-book ion-icon-big wow fadeInUp thick3" data-wow-delay="0.2s"></i><p>JEUNESSE</p></a></li>
                     <li><a href="bande_dessinees.php"><i class="ion-ios-book ion-icon-big wow fadeInUp thick" data-wow-delay="2.2s"></i><p>BANDES DESSINÉES</p></a></li>
                  </ul>
                </div>  
            </div>
        </div>
    ...
    <div class="background-librairie">
        ...
        <div class="thick text-center"><i class="ion-ios-book ion-icon-big thick3"></i><p class="thick2">JEUNESSE</p></li></div>
        <div class="cart-icon">
        ...
        $resultat = mysqli_query($connect,"SELECT * FROM `librairie` WHERE produit LIKE 'jeunesse'");
        while($row = mysqli_fetch_assoc($resultat))
        {
            ...
            "<div class='iso-box col-md-4 col-sm-6'>
                <form action='' method='post'>
                    ...
                    <div class='image'><a href='read.php'><img src='".$row['image']."'></div>  
