...
<section id="portfolio">
    ...
    <div class="background-librairie">
        ...
        <div class="thick text-center"><i class="ion-ios-book ion-icon-big thick3"></i><p class="thick2">ROMANS</p></li></div>
        <div class="cart-icon">
        ...
        $resultat = mysqli_query($connect,"SELECT * FROM `librairie` where produit like 'roman'");
