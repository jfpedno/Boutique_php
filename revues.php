...
<section id="portfolio">
            ...
            <div class="col-md-12 col-sm-12">           
               <div class="iso-section wow fadeInUp">
                  <ul class="filter-wrapper">
                     ...
                     <li><a href="revues.php"><i class="ion-ios-book ion-icon-big wow fadeInUp thick3" data-wow-delay="0.2s"></i><p>MAGAZINES</p></a></li>
    ...
    <div class="background-librairie">
        ...
        <div class="thick text-center"><i class="ion-ios-book ion-icon-big thick3"></i><p class="thick2">REVUES</p></li></div>
        <div class="cart-icon">
        ...
        $resultat = mysqli_query($connect,"SELECT * FROM `librairie` where produit like 'revue'");
